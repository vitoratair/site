  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-6xl justify-end">
        <Reveal className="max-w-lg" delayMs={0}>
          <div className="card-lift rounded-2xl border border-slate-500/35 bg-slate-800/55 p-8 shadow-xl shadow-black/20 backdrop-blur-md sm:p-10">
