        ...
        <ul className="mt-16 grid list-none gap-6 p-0 sm:grid-cols-2">
          {skills.map((s, i) => (
            <li key={s.title} className="min-h-0">
              <Reveal className="h-full" delayMs={i * 65}>
                <div className="card-lift group relative h-full overflow-hidden rounded-2xl border border-slate-600/30 bg-gradient-to-br from-slate-800/70 to-slate-900/85 p-6 shadow-md shadow-black/15 backdrop-blur-sm sm:p-7">
